                ...
                <div class="main-content">
                            ...
                            <div class="col-md-6">
                                <div class="media m-v-10">
                                    ...
                                    <div class="media-body m-l-15">
                                        <h6 class="mb-0">Alle aanmeldingen (9)</h6>
                                        <span class="text-gray font-size-13">Zelfstandig werkend kok</span>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-11 mx-auto">
                            ...
                            <div class="row" id="list-view" onclick="window.location.href='/dashboard/canidate.php';">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <a href="/dashboard/canidate.php" class="btn btn-primary btn-tone">
                                                                        <i class="anticon anticon-mail"></i>
                                                                        <span class="m-l-5">Bekijk</span>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr>
